...
const burnerMachine: MachineDefinition = {
  ...
  states: [
    { id: "idle", name: "Idle", kind: "initial", position: { x: 80, y: 300 }, sectionId: "sec_preparation", regionId: "region_startup", entryActions: ["clear start latch"], relatedSignalIds: ["sig.operator.burnerStartCmd"], relatedBlockIds: ["block_start_stop_latch"], relatedBindingIds: ["bind_burner_start"] },
    { id: "pre_start_checks", name: "PreStartChecks", kind: "normal", position: { x: 340, y: 300 }, sectionId: "sec_preparation", regionId: "region_startup", entryActions: ["verify permissives"], timeoutMs: 4000, relatedSignalIds: ["sig.protection.startPermissive", "sig.feedwater.waterOk"], relatedBlockIds: ["block_permissive_matrix"], relatedBindingIds: ["bind_trip_chain", "bind_water_level"] },
    { id: "pre_purge", name: "PrePurge", kind: "normal", position: { x: 600, y: 300 }, sectionId: "sec_preparation", regionId: "region_startup", entryActions: ["fan start", "damper open"], timeoutMs: 15000, relatedSignalIds: ["sig.air.fanRunFb"], relatedBlockIds: ["block_timer_on"], relatedBindingIds: ["bind_fan_run"] },
    { id: "ignition", name: "Ignition", kind: "normal", position: { x: 860, y: 300 }, sectionId: "sec_lightoff", regionId: "region_lightoff", entryActions: ["igniter on", "pilot fuel open"], timeoutMs: 5000, relatedSignalIds: ["sig.flame.detected"], relatedBlockIds: ["block_flame_prover"], relatedBindingIds: ["bind_flame_detected"] },
    { id: "flame_proving", name: "FlameProving", kind: "normal", position: { x: 1120, y: 300 }, sectionId: "sec_lightoff", regionId: "region_lightoff", entryActions: ["prove flame"], timeoutMs: 3000, relatedSignalIds: ["sig.flame.detected"], relatedBlockIds: ["block_flame_prover"], relatedBindingIds: ["bind_flame_detected"] },
    { id: "low_fire_stabilize", name: "LowFireStabilize", kind: "normal", position: { x: 1380, y: 300 }, sectionId: "sec_lightoff", regionId: "region_lightoff", entryActions: ["hold low fire"], timeoutMs: 8000, relatedSignalIds: ["sig.steam.pressure"], relatedBlockIds: ["block_pressure_pid"], relatedBindingIds: ["bind_steam_pressure"] },
    { id: "modulating_run", name: "ModulatingRun", kind: "normal", active: true, position: { x: 1640, y: 300 }, sectionId: "sec_run", regionId: "region_run", entryActions: ["enable pressure loop"], relatedSignalIds: ["sig.steam.pressure"], relatedBlockIds: ["block_pressure_pid"], relatedBindingIds: ["bind_steam_pressure"] },
    { id: "normal_stop", name: "NormalStop", kind: "final", position: { x: 1380, y: 540 }, sectionId: "sec_shutdown", regionId: "region_shutdown", entryActions: ["close main fuel"], timeoutMs: 4000, relatedSignalIds: ["sig.operator.burnerStopCmd"], relatedBlockIds: ["block_start_stop_latch"], relatedBindingIds: ["bind_burner_stop"] },
    { id: "post_purge", name: "PostPurge", kind: "final", position: { x: 1120, y: 540 }, sectionId: "sec_shutdown", regionId: "region_shutdown", entryActions: ["fan cool-down purge"], timeoutMs: 10000, relatedSignalIds: ["sig.air.fanRunFb"], relatedBlockIds: ["block_timer_on"], relatedBindingIds: ["bind_fan_run"] },
    { id: "fault_lockout", name: "FaultLockout", kind: "fault", position: { x: 1120, y: 60 }, sectionId: "sec_fault", regionId: "region_fault", entryActions: ["trip fuel", "latch fault"], relatedSignalIds: ["sig.feedwater.lowLowWaterTrip", "sig.protection.tripChainHealthy"], relatedBlockIds: ["block_interlock_set"], relatedBindingIds: ["bind_low_low_water_trip", "bind_trip_chain"] }
  ],
  transitions: [
...
export const demoProject: UniversalPlcDemoProject = {
  ...
  signals: [
    ...
    { id: "sig.operator.burnerStartCmd", name: "sig.operator.burnerStartCmd", layer: "semantic", summary: "Semantic burner start command available to system objects.", type: "bool", direction: "input", value: false, derivedFromSignalIds: ["cond.operator.start_cmd"], consumerRefs: [{ objectId: "burner", portKind: "command", portName: "start" }], producerRef: { objectId: "operator_panel_selectors", portKind: "output", portName: "burnerStartCmd" } },
    ...
    { id: "sig.operator.burnerStopCmd", name: "sig.operator.burnerStopCmd", layer: "semantic", summary: "Semantic burner stop command available to system objects.", type: "bool", direction: "input", value: false, derivedFromSignalIds: ["cond.operator.stop_cmd"], consumerRefs: [{ objectId: "burner", portKind: "command", portName: "stop" }], producerRef: { objectId: "operator_panel_selectors", portKind: "output", portName: "burnerStopCmd" } },
    ...
    { id: "sig.operator.burnerResetCmd", name: "sig.operator.burnerResetCmd", layer: "semantic", summary: "Semantic burner reset command available to system objects.", type: "bool", direction: "input", value: false, derivedFromSignalIds: ["cond.operator.reset_cmd"], consumerRefs: [{ objectId: "burner", portKind: "command", portName: "reset" }], producerRef: { objectId: "operator_panel_selectors", portKind: "output", portName: "burnerResetCmd" } },
    ...
    { id: "sig.operator.burnerMode", name: "sig.operator.burnerMode", layer: "semantic", summary: "Semantic burner mode used by Burner and FuelGroup.", type: "string", direction: "input", value: "AUTO", derivedFromSignalIds: ["cond.operator.mode_selector"], consumerRefs: [{ objectId: "burner", portKind: "input", portName: "burnerMode" }, { objectId: "fuel_group", portKind: "input", portName: "fuelModeSelect" }], producerRef: { objectId: "operator_panel_selectors", portKind: "status", portName: "burnerMode" } },
